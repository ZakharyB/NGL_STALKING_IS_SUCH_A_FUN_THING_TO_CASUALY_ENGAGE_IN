...
class PersonSearchApp(tk.Tk):
    ...
    def perform_search(self):
        ...
        for i, platform in enumerate(self.platforms):
            if self.platform_vars[i].get():
                ...
                self.results_text.insert(tk.END, f"Preview: {result['preview']}\n\n")
    ...
    def search_platform(self, platform, first_name, last_name, phone, email, date_query, direct_search):
        ...
        return {"platform": platform, "url": url, "preview": preview}
    ...
    def export_results(self):
        ...
        with open(file_path, 'w', newline='') as csvfile:
            writer = csv.DictWriter(csvfile, fieldnames=["platform", "url", "preview"])
            writer.writeheader()
